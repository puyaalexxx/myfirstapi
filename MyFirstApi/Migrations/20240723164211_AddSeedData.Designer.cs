...
namespace MyFirstApi.Migrations
{
    ...
    [Migration("20240723164211_AddSeedData")]
            ...
            modelBuilder.Entity("MyFirstApi.Models.Invoice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3f886ca2-3988-4a15-a85b-7cfec816dbf3"),
                            Amount = 100m,
                        ...
                        new
                        {
                            Id = new Guid("c57040fb-01ec-4739-b706-42a9906e41b0"),
                            Amount = 200m,
                        ...
                        new
                        {
                            Id = new Guid("6056d713-e706-44df-bc40-6b0855a76f6a"),
                            Amount = 300m,
                            ContactName = "Thor",
                            Description = "Invoice for the first month",
                            DueDate = new DateTimeOffset(new DateTime(2021, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),

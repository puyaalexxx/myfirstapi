...
namespace MyFirstApi.Migrations
{
    ...
    [Migration("20240724125752_AddMovieActorTable")]
            ...
            modelBuilder.Entity("MyFirstApi.Models.Invoice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("81bb59e4-d0ca-4ac8-a1f8-a0972f2e8588"),
                            Amount = 100m,
                        ...
                        new
                        {
                            Id = new Guid("5f97acc6-567d-4692-ab4b-12b758a247a3"),
                            Amount = 200m,
                        ...
                        new
                        {
                            Id = new Guid("e1d710ee-73ec-4a90-ae69-8efad20fdf9e"),
                            Amount = 300m,
                            ContactName = "Thor",
                            Description = "Invoice for the first month",
                            DueDate = new DateTimeOffset(new DateTime(2021, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
